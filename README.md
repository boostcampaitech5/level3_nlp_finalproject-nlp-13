...
<img src="/resources/model2.png" width="450px" height="300px" title="px(픽셀) 크기 설정" alt="model2"></img><img src="/resources/model3.png" width="450px" height="300px" title="px(픽셀) 크기 설정" alt="model3"></img><br/>
